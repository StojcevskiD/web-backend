create or replace function create_user_if_not_exists(_email text, _password text, _role text, _name text, _surname text) returns void as
$$
...
select create_user_if_not_exists('admin@gmail.com', '$2a$10$HUQq8rT61bAX3jq5QGhO3uQ0ueeqEo3Ag4XOTwlgpruf5qoFjvIq6', 'ROLE_ADMIN', 'admin', 'adminov');
